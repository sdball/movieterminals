...
muthur.ship_status = function (terminal) {
  ...
  terminal.print(
    "ACTUAL TIME:   3 JUN                         NOSTROMO 180245"
  );
...
muthur.address_matrix = function (terminal) {
  ...
  $("#display").append(
    '<p><span class="selection_option">INTERFACE    2037</span>         DECK A         A3003</p>'
  );
...
muthur.script = {
  ...
  commands: {
    ...
    "request clarification on science inability to neutralize alien":
      muthur.request_science_clarification,
